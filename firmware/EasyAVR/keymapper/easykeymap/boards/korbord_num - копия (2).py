...
#      Port        Pin mask
    ( REF_PORTB , (1 << 4) ),
    ( REF_PORTB , (1 << 7) ), # скорее всего нужно указать num_cols меньше и  уменьшать номера в таблице
    ( REF_PORTC , (1 << 6) ),
    ( REF_PORTC , (1 << 7) ),
    ( REF_PORTD , (1 << 0) ),
    ( REF_PORTD , (1 << 1) ),
...
# A0 = 20 = PD2 - 3,4,5   != 3D2_6  = 17
# A1 = 21 = PD3 - 9,10,11 != 3D2_8  = 16
# A2 = 19 = PD1 - 1,2,13  != 3D2_12 = 15
#
...
((4, 4), (5, 15), 'HID_KEYBOARD_SC_NUM_LOCK'),                 #OK
((4, 4), (7, 15), 'HID_KEYBOARD_SC_D'),	                       #OK
((4, 4), (5, 17), 'HID_KEYBOARD_SC_E'),                        #OK
((4, 4), (5, 16), 'HID_KEYBOARD_SC_F'),                        #OK
...
(4, None, '0'),		 
((4, 4), (3, 15), 'HID_KEYBOARD_SC_A'),                        #OK
((4, 4), (7, 17), 'HID_KEYBOARD_SC_B'),	                       #OK
((4, 4), (7, 16), 'HID_KEYBOARD_SC_C'),                        #OK
((4, 4), (6, 16), 'HID_KEYBOARD_SC_KEYPAD_ASTERISK')	       #OK
     ],[

(4, None, '0'),		 
((4, 4), (1, 15), 'HID_KEYBOARD_SC_KEYPAD_7_AND_HOME'),        #OK
...
(4, None, '0'),	 	 
((4, 4), (6, 15), 'HID_KEYBOARD_SC_KEYPAD_4_AND_LEFT_ARROW'),  #OK
((4, 4), (1, 17), 'HID_KEYBOARD_SC_KEYPAD_5'),                 #OK
((4, 4), (2, 17), 'HID_KEYBOARD_SC_KEYPAD_6_AND_RIGHT_ARROW'), #OK
((4, 4), (4, 16), 'HID_KEYBOARD_SC_KEYPAD_PLUS')	 #4,4,7,2  #OK
     ],[
(4, None, '0'),

((4, 4), (2, 15), 'HID_KEYBOARD_SC_KEYPAD_1_AND_END'),         #OK
((4, 4), (6, 17), 'HID_KEYBOARD_SC_KEYPAD_2_AND_DOWN_ARROW'),  #OK
((4, 4), (4, 17), 'HID_KEYBOARD_SC_KEYPAD_3_AND_PAGE_DOWN'),   #OK
((4, 8), (0, 16), 'HID_KEYBOARD_SC_KEYPAD_ENTER')              #OK
...
(4, None, '0'),
((4, 4), (4, 15), 'HID_KEYBOARD_SC_KEYPAD_0_AND_INSERT'),      #OK
((4, 4), (0, 15), 'HID_KEYBOARD_SC_KEYPAD_DOT_AND_DELETE'),    #OK
((4, 4), (0, 17), 'HID_KEYBOARD_SC_SLASH_AND_QUESTION_MARK')   #OK
     ]
]
