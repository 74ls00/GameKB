...
(4, None, '0'),
     ...
     ((4, 4), (1, 5), 'HID_KEYBOARD_SC_F3'),
     ((4, 4), (1, 6), 'HID_KEYBOARD_SC_F4'),
     (2, None, '0'),
     ((4, 4), (1, 7), 'HID_KEYBOARD_SC_F5'),
     ((4, 4), (1, 8), 'HID_KEYBOARD_SC_F6'),
	 (2, None, '0'),	 
     ((4, 4), (1, 9), 'HID_KEYBOARD_SC_F7'),
     ((4, 4), (1, 10), 'HID_KEYBOARD_SC_F8'),
     (2, None, '0'),
     ((4, 4), (1, 11), 'HID_KEYBOARD_SC_F9'),
     ((4, 4), (1, 12), 'HID_KEYBOARD_SC_F10'),
     ((4, 4), (1, 13), 'HID_KEYBOARD_SC_F11'),
     ((4, 4), (1, 14), 'HID_KEYBOARD_SC_F12'),
	 (2, None, '0'),
	 ((4, 4), (1, 15), 'HID_KEYBOARD_SC_DELETE'),
(2, None, '0'),	 
	 ((4, 4), (1, 16), 'HID_KEYBOARD_SC_NUM_LOCK'),
((4, 4), (1, 17), 'HID_KEYBOARD_SC_D'),	
((4, 4), (1, 18), 'HID_KEYBOARD_SC_E'),
((4, 4), (1, 19), 'HID_KEYBOARD_SC_F'),
((4, 4), (1, 20), 'HID_KEYBOARD_SC_KEYPAD_SLASH') 
	 ],
	 #2,
	 [
	 ((4, 4), (2, 1), 'HID_KEYBOARD_SC_INSERT'),
	 ((4, 4), (2, 2), 'HID_KEYBOARD_SC_PAUSE'),
(6, None, '0'),	 
...
((7, 4), (4, 5), 'HID_KEYBOARD_SC_RIGHT_SHIFT'),#11
(7, None, '0'),		   
...
(4, None, '0'),
	 ((4, 4), (6, 17), 'HID_KEYBOARD_SC_KEYPAD_0_AND_INSERT'),#8,
